...
| # | Phase | Status |
|---|-------|--------|
| 1 | Taxonomy — merge duplicates, deepen themes (76 → 138), record retired names, related topics for every theme | ✅ 2026-09-17 |
| 2 | Personalities — all 79 retagged on the shared vocabulary | ✅ 2026-09-17 |
| 3 | Asma ul Husna — all 99 names tagged, duplicate categories merged | ✅ 2026-09-17 |
| 4 | Ayaat — surah-by-surah deep pass, all 114 surahs (status table at the bottom) | ✅ 2026-09-18 |
| 5 | Final review — theme sizes, exact-count checks, consistency sweep | ✅ 2026-09-18 |

---

## How to do one step (Phase 4)

1. Pick the next surah that is not ✅ in the table below.
...
- **Titles:** every theme title is now unique. Emojis were made unique first (before, 14
  emojis were shared by 30 themes — 🕌 for both Tawheed and Salah, ⚖️ for Akhirah, Adl
